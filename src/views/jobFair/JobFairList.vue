    ...
    <div class="container">
        ...
        <div class="findDiv">
            <div>
                ...
                <el-date-picker v-model="startDate" type="date" size="mini" placeholder="请选择开始日期"></el-date-picker>
                <el-date-picker v-model="endDate" type="date" size="mini" placeholder="请选择结束日期"></el-date-picker>
        ...
        <div class="showDiv">
            ...
            <el-pagination background layout="prev,pager,next" :total="page.total"></el-pagination>
        </div>
    </div>
</template>

<script>
    import {getData} from "@/datas/jobFairDatas";
